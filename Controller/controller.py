...
class Controller:
    ...
    def __restart_game(self):
        ...
        self.__init__(self.__game_board, self.__move, self.__winner,self.__view,self.players)
        ...
        while self.__running:
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN and self.__starting_game==True:
                    ...
                    # board, x,y, move, game_board, winner, player_turn)
                    # player3 = self.players.play('human')
                    # self.__player_turn= player3.playing(self.__board, x,y, self.__move, self.__game_board, self.__winner, self.__player_turn)
